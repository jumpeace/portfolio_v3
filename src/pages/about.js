...
export default function About() {
    ...
    特に React や Django を使った Web 開発に熱中していた。 2022 年冬には HackU Kosen 2022 でクラスメートと共に最優秀賞を受賞。
                        ...
                        <p>2023 年に東京農工大学に編入学。国際交流と他大学の学生との交流のために IAESTE を支援する学生ボランティアに参加中。</p>
                        <p>　</p>
                        <p>今後はIT系の技術をより幅広く学び、より便利で安全なシステムを開発できるようになりたいです。</p>
                        <p>また英語学習を続けて、グローバルに活躍できる IT エンジニアとして働きたいと考えています。</p>
                    </div>
                </div>
                <div className={`fixed top-0 left-0 w-full h-screen z-[-1] opacity-10`}>
                    <Image src={`/icon.png`} alt="background image for 'about me' page" layout={`fill`} objectFit={`cover`} />
                </div>
            </div>
            <Footer />
            <NavBar />
